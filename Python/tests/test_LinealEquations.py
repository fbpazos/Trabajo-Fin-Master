...
class Test_LUInteractive(TestCase):
    ...
    def test_step(self):
        ...
        buttons = [button for row in self.luVisualizer.buttonsMatrix for button in row if not button.disabled]
        ...
        buttons2 = [button for row in self.luVisualizer.buttonsMatrix for button in row if not button.disabled]
    ...
    def test_previousStep(self):
        ...
        oldStep = (self.luVisualizer.step,self.luVisualizer.L, self.luVisualizer.U, self.luVisualizer.P)
    ...
    def test_reset(self):
        ...
        self.assertTrue(all([button.disabled for row in self.luVisualizer.buttonsMatrix for button in row]))
        ...
        self.assertTrue(any([not button.disabled for row in self.luVisualizer.buttonsMatrix for button in row]))
