\begin{titlepage}
	...
	\begin{center}
		\begin{figure}[H] % UC3M Logo
			\makebox[\textwidth][c]{\includegraphics[width=16cm]{Include/Images/logo_UC3M.png}}
		\end{figure}
		\vspace{2.5cm}
		\begin{Large}
			Master Degree in \Edu\\			
	...
	\noindent\includegraphics[width=4.2cm]{Include/Images/creativecommons.png}\\ % Creative Commons Logo
