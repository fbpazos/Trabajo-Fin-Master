...
\chapter*{Appendix: Github Actions}
\hypertarget{Appendix:GithubActions}{}
\subsection*{Latex Compilation}
\addcontentsline{toc}{section}{Github Actions}
\begin{lstlisting}
...
\includepdf[pages=1,scale=1,pagecommand=\chapter*{Appendix: SonarQube Report}]{Include/PDFs/BNumMet-analysis-report.pdf} \hypertarget{Appendix:SonarqubeReport}{}
\addcontentsline{toc}{section}{SonarQube Report}
